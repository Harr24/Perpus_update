...
<head>
    ...
    <title>Login Superadmin - Multicomp</title>
...
<body>
    <div class="login-container">
        ...
        <div class="login-header">
            ...
            <p class="login-subtitle">Portal kendali utama administrator sistem.</p>
        </div>
        ...
        <form method="POST" action="{{ route('superadmin.login.process') }}">
            @csrf

            <div class="input-group">
                <label for="email">Email</label>
                <input id="email" type="email" name="email" value="{{ old('email') }}" required autofocus autocomplete="off" placeholder="admin@email.com">
                @error('email')
        ...
        <div class="login-footer" style="margin-top: 25px; border-top: 1px solid #e5e7eb; padding-top: 15px;">
